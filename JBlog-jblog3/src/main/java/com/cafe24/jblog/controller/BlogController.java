...
public class BlogController {
	...
	public String adminSkinUpdate(@ModelAttribute BlogVo blogVo) {
//		System.out.println("logoFile"+blogVo.getLogoFile().getOriginalFilename());
		//로고 저장 서비스 호출
		if(blogVo.getLogoFile().isEmpty()==false) {
			blogVo.setLogo(blogService.fileRestore(blogVo.getLogoFile()));
		}
		System.out.println("로고이름은="+blogVo.getLogo());
		//수정
